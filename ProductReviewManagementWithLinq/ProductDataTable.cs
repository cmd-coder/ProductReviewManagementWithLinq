...
namespace ProductReviewManagementWithLinq
{
    class ProductDataTable
    {
        public static void DataTableOfProducts()
        {
            ...
            productTable.Rows.Add("1", 10, 2, "Good", true);
            productTable.Rows.Add("2", 10, 4, "Good", true);
            productTable.Rows.Add("3", 10, 5, "Good", true);
            productTable.Rows.Add("4", 10, 6, "Good", false);
            productTable.Rows.Add("5", 10, 2, "Nice", true);
            ...
            Console.WriteLine("---------------------");
            Console.WriteLine("Use Case 12: Order All The Records By Their Rating With UserID=10");
            Console.WriteLine("---------------------");
            OrderAllRecordsWithUserID10(productTable);
        ...
        public static void OrderAllRecordsWithUserID10(DataTable productTable)
        {
            var recordedData = from products in productTable.AsEnumerable() where products.Field<int>("UserID") == 10 orderby products.Field<int>("Rating") select products;
            foreach (var list in recordedData)
            {
                Console.WriteLine("ProductID: " + list[0] + " UserID: " + list[1] + " Rating: " + list[2] + " Review: " + list[3] + " isLike: " + list[4]);
            }
